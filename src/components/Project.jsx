...
function Project({data}) {
  ...
  return (
    <a href={data?.link} target='_blank' className='self-stretch w-[48%] bg-l-secondary dark:bg-d-secondary rounded-lg flex flex-col gap-4 justify-start items-center px-[0.5rem] py-[0.25rem] tablet:py-[1rem] tablet:px-[1rem]'>
        <img className='w-[64px] h-[64px] desktop:w-full desktop:h-[80px] rounded-lg aspect-auto object-cover' src={imageMap[data?.img]} alt="img" />
        <div className='font-over flex flex-col justify-between items-start flex-wrap py-[0.5rem] gap-2'>
            ...
            <div className='text-[12px] font-extralight italic flex gap-[0.25rem]'>
