...
function Project({data}) {
  ...
  return (
    <a href={data?.link} target='_blank' className='self-stretch w-[100%] tablet-lg:w-[48%] h-auto bg-l-secondary dark:bg-d-secondary rounded-lg flex flex-col gap-2 tablet:gap-4 justify-start items-center px-[0.5rem] py-[0.5rem] tablet:py-[1rem] tablet:px-[1rem]'>
