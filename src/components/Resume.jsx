  ...
  return (
    <div className='relative outline outline-l-secondary outline-[2px] rounded-xl px-[1rem] mb-[6rem] laptop:basis-[70%] laptop:mt-[6rem]'>
        <div className='left-0 top-6 box-border font-mont font-bold text-[1rem] tablet-lg:text-[18px] bg-l-text absolute w-[8rem] rounded-sm border-r-[15px] border-r-l-primary  border-t-[16px] border-b-[16px] border-t-l-text border-b-l-text'>
            <h1 className='absolute -top-3 left-2 text-l-primary'>Resume</h1>
        </div>
        <div className='flex flex-col justify-start items-start pt-[5rem] pb-[1rem]'>
            ...
            <div className='w-[100%] my-[1.5rem] flex flex-col gap-[1rem] items-start'>
                ...
                <div className='self-stretch flex flex-col justify-start items-start gap-2 grow bg-l-secondary rounded-md font-over px-[1rem] py-[0.5rem]'>
            ...
            <div className='w-[100%] my-[1.5rem] flex flex-col gap-[1rem] items-start'>
                ...
                <div className='self-stretch flex justify-between items-start gap-2 grow bg-l-secondary rounded-md font-over px-[1.5rem] tablet:pr-[6rem] py-[0.75rem]'>
            ...
            <a href={res} download="resume" className='self-stretch flex justify-center items-baseline gap-2 grow bg-l-secondary rounded-md font-over font-light text-[12px] text-l-text px-[1rem] py-[0.5rem]'>
