    ...
    <div data-aos="fade" className=' relative outline outline-l-secondary dark:outline-d-secondary outline-[2px] rounded-xl px-[1rem] mb-[6rem] laptop:basis-[70%] laptop:mt-[6rem]'>
        ...
        <div className='flex flex-col justify-start items-start pt-[5rem] pb-[1rem]'>
            ...
            <div className='w-[100%] my-[1rem] flex flex-col gap-[1rem] items-start'>
                ...
                <h2 className='font-mont font-bold text-[18px] tablet:text-[20px] text-start self-start'>Experience</h2>
                ...
                <div className='self-stretch flex flex-col justify-start items-start gap-2 grow bg-l-secondary dark:bg-d-secondary rounded-md font-over px-[1rem] py-[0.5rem]'>
                    <h2 className='font-medium text-[14px] tablet:text-[16px] text-start'>Design Intern</h2>
                    <p className='text-start font-light text-[12px] tablet:text-[14px]'>
                        Jul 2022 - Nov 2022 <br></br>
                        DailyDumbbell
                    </p>
                    <p className='text-start font-light text-[14px] tablet:text-[16px] leading-4'>
                    Worked on establishing a compelling social media presence for the brand while also contributing to the design of the user interface for both the website and app. <br></br><br></br>
                    Tools & Skills used - <span className='font-medium text-[12px] tablet:text-[14px] italic'> Figma, Canva, Photoshop, UI/UX & Visual Identity</span>
                    </p>
                </div>
            </div>
            ...
            <div className='w-[100%] my-[1rem] flex flex-col gap-[1rem] items-start'>
                ...
                <h2 className='font-mont font-bold text-[18px] tablet:text-[20px] text-start self-start'>Tech Stack</h2>

                <div className='self-stretch flex justify-between items-center gap-2 grow bg-l-secondary dark:bg-d-secondary rounded-md font-over p-[1rem]'>
                    <div className='w-[50%] flex flex-col items-start font-over font-light text-[12px] tablet:text-[14px] gap-2'>
            ...
            <div className='w-[100%] mt-[1rem] mb-[2rem] flex flex-col gap-[1rem] items-start'>
                ...
                <h2 className='font-mont font-bold text-[18px] tablet:text-[20px] text-start self-start'>Education</h2>

                <div className='self-stretch flex flex-col justify-start items-start gap-2 grow bg-l-secondary dark:bg-d-secondary rounded-md font-over px-[1rem] py-[0.5rem]'>
                    <h2 className='font-medium text-[14px] tablet:text-[16px] text-start'>Bachelor In Technology (Information Technology)</h2>
                ...
                <div className='self-stretch flex flex-col justify-start items-start gap-2 grow bg-l-secondary dark:bg-d-secondary rounded-md font-over px-[1rem] py-[0.5rem]'>
                <h2 className='font-medium text-[14px] tablet:text-[16px] text-start'>ISC - (Computer Science)</h2>
                    <p className='text-start font-light text-[14px]'>
                        2019 - 2021 <br></br>
                        BGES (ISC)
                    </p>
                ...
                <div className='self-stretch flex flex-col justify-start items-start gap-2 grow bg-l-secondary dark:bg-d-secondary rounded-md font-over px-[1rem] py-[0.5rem]'>
                <h2 className='font-medium text-[14px] tablet:text-[16px] text-start'>ISCE - (Science)</h2>
                    <p className='text-start font-light text-[14px]'>
                        2009 - 2019 <br></br>
                        Loyola High School
                    </p>
