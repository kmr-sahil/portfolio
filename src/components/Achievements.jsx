    ...
    <>
        <div className=' flex flex-col gap-[1rem] items-center'>
                ...
                <div className='flex flex-wrap gap-1 tablet-lg:gap-3'>
                    ...
                    <Link to="https://github.com/swarraaa/PushNotes" className='bg-l-secondary dark:bg-d-secondary px-[0.5rem] py-[0.25rem] font-over font-medium text-[12px] tablet:text-[14px] rounded-md text-start'>Built Task Management System at BlueLearn's Proto-Drive Hackathon</Link>
                </div>
            </div>
    </>
  )
