    ...
    <>
        <div className=' flex flex-col gap-[1rem] items-center'>
                ...
                <div className='flex flex-wrap gap-1 tablet:gap-4'>
                    ...
                    <Link to="" className='flex items-center justify-center bg-l-secondary dark:bg-d-secondary px-[0.5rem] py-[0.25rem] font-over font-medium text-[10px] tablet-lg:text-[12px] rounded-md text-start'>Built Task Management System at BlueLearn's Proto-Drive Hackathon</Link>
                </div>
            </div>
    </>
  )
