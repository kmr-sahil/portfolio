...
function Info() {
  return (
    <div className=' flex laptop:flex-col gap-[20px] justify-center laptop:justify-start mb-[20px] laptop:basis-[30%] laptop:mt-[6rem]'>
        <div className='grow basis-[70%] laptop:grow-0 laptop:basis-[0%] font-mont flex flex-col tablet:flex-row laptop:flex-col tablet:gap-4 justify-center items-center outline outline-l-secondary dark:outline-d-secondary outline-[2px] rounded-xl py-[24px]'>
        ...
        <div className='text-l-text dark:text-d-secondary text-[1.25rem] flex basis-[10%] laptop:basis-[0%] flex-col laptop:flex-row flex-wrap justify-between tablet:gap-4 outline outline-l-secondary dark:outline-d-secondary outline-[2px] rounded-xl px-[18px] py-[24px] laptop:py-[16px]'>
